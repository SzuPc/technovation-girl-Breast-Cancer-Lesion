...
if __name__ == "__main__":
    ...
    #     save_dir="/home/lenovo/zrl_science_project/UltraDet/visualizations/CVA_BUS_Anno",
    #     dataset_name="breast_cva_test"    
    # )
    visualize_results(
        pred_dir="/home/lenovo/zrl_science_project/UltraDet/output/predictions/breast_cva_test",
        save_dir="/home/lenovo/zrl_science_project/UltraDet/visualizations/CVA_BUS_pred",
        dataset_name="breast_cva_test",
        score_thresh=0.7,         
    )